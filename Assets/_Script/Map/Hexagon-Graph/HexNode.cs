...
namespace _Script.Map.Hexagon_Graph
{
    ...
    {
        // Cube coordinates
        private readonly Vector3Int _position; public Vector3Int Position => _position;
        ...
        private readonly MapNode _mapNode; public MapNode MapNode => _mapNode;
        ...
        {
            return (Mathf.Abs(_position.x - other.Position.x) + Mathf.Abs(_position.y - other.Position.y) + Mathf.Abs(_position.z - other.Position.z)) / 2;
        }
